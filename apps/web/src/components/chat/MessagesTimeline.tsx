  ...
  return (
    <div className="flex justify-end">
      <div className="group flex max-w-[80%] flex-col items-end">
        <div className="relative rounded-2xl rounded-br-sm bg-secondary px-4 py-3">
          {userImages.length > 0 && (
  ...
  if (props.terminalContexts.length > 0) {
    ...
    if (hasEmbeddedInlineLabels) {
      ...
      if (inlineNodes.length > 0) {
        ...
        return (
          <div className="chat-typography whitespace-pre-wrap wrap-break-word text-sm leading-relaxed text-foreground">
            {inlineNodes}
          </div>
        );
      }
