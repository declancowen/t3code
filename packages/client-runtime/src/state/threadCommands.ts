...
import {
  ...
  type DispatchThreadQueuedMessageInput,
  type EditThreadQueuedMessageInput,
  type InterruptThreadTurnInput,
  type RemoveThreadQueuedMessageInput,
...
export type {
  ...
  CreateThreadInput,
  DeleteThreadInput,
  DispatchThreadQueuedMessageInput,
  EditThreadQueuedMessageInput,
  InterruptThreadTurnInput,
  RemoveThreadQueuedMessageInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    removeQueuedMessage: createEnvironmentCommand(runtime, {
      ...
      execute: (input: RemoveThreadQueuedMessageInput) => removeThreadQueuedMessage(input),
      scheduler,
      concurrency,
    }),
    editQueuedMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:edit-queued-message",
      execute: (input: EditThreadQueuedMessageInput) => editThreadQueuedMessage(input),
      scheduler,
      concurrency,
    }),
    dispatchQueuedMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:dispatch-queued-message",
      execute: (input: DispatchThreadQueuedMessageInput) => dispatchThreadQueuedMessage(input),
      scheduler,
      concurrency,
    }),
